        ...
        <ul class="navbar-nav navbar-nav-right">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
              ...
              <a class="dropdown-item preview-item">
                ...
                <div class="preview-item-content flex-grow">
                  ...
                  <p class="font-weight-light small-text">
                    Se efectuará revisión de puntajes
                  </p>
                </div>
              </a>
            </div>
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
              ...
              <a class="dropdown-item preview-item">
                ...
                <div class="preview-item-content">
                  <h6 class="preview-subject font-weight-medium text-dark">Error en la aplicación</h6>
                  <p class="font-weight-light small-text">
                    Justo ahora
                  </p>
                </div>
              ...
              <a class="dropdown-item preview-item">
                ...
                <div class="preview-item-content">
                  <h6 class="preview-subject font-weight-medium text-dark">Configuración</h6>
                  <p class="font-weight-light small-text">
                    Mensajes privados
                  </p>
                </div>
              ...
              <a class="dropdown-item preview-item">
                ...
                <div class="preview-item-content">
                  <h6 class="preview-subject font-weight-medium text-dark">Nuevos usuarios registrados</h6>
                  <p class="font-weight-light small-text">
                    2 dias atrás
                  </p>
                </div>
          ...
          <li class="nav-item dropdown d-none d-xl-inline-block">
            <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
              <span class="profile-text">Hola, Richard V.Welsh !</span>
